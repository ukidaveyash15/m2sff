...
void si_gpu_read_config(void)
{
	...
	si_gpu_fast_forward = config_read_int(gpu_config, section,
				"FastForward", si_gpu_fast_forward);
		if (si_gpu_fast_forward != 0 && si_gpu_fast_forward != 1)
			fatal("%s: invalid value for 'FastForward'.\n%s",
				si_gpu_config_file_name, err_note);
