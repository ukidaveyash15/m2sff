.global calNumEigenValueInterval
...
.args
	...
	u32* numEigenIntervals 0 uav12 RW
	float* eigenIntervals 16 uav11 RO
	float* diagonal 32 uav10 RO
	float* offDiagonal 48 uav13 RO
	u32 width 64
...
label_0080:
  v_lshlrev_b32  v0, 2, v0                                  // 00000200: 34000082
  v_add_i32     v0, vcc, s16, v0                            // 00000204: 4A000010
  v_cvt_f32_u32  v2, v2                                     // 00000208: 7E040D02
  v_cvt_u32_f32  v2, v2                                     // 0000020C: 7E040F02
  v_sub_i32     v1, vcc, v2, v3                             // 00000210: 4C020702
  s_load_dwordx4  s[0:3], s[2:3], 0x60                      // 00000214: C0800360
...
.global recalculateEigenIntervals
...
.args
	...
	float* newEigenIntervals 0 uav12 RW
	float* eigenIntervals 16 uav11 RO
	u32* numEigenIntervals 32 uav13 RO
	float* diagonal 48 uav10 RO
	float* offDiagonal 64 uav14 RO
	u32 width 80
	float tolerance 96
